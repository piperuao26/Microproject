...
<head>
  ...
  <title>@yield('title', 'Tienda en linea')</title>
</head>
<body>
  <!-- header -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <a class="nav-link active" href="{{ route('home.index') }}">Inicio</a>
          <a class="nav-link active" href="{{ route('computer.index') }}">Computadores</a>
  ...
  <header class="masthead bg-primary text-white text-center py-4">
    <div class="container d-flex align-items-center flex-column">
      <h2>@yield('subtitle', 'Micro Project EAFIT ')</h2>
    </div>
  </header>
  <!-- header -->
  ...
  <div class="copyright py-4 text-center text-black">
    <div class="container">
      <small>
        Created by - <a class="text-reset fw-bold text-decoration-none" target="_blank"
          href="https://youtu.be/6BqppKUr9bY">
          Andres Rua
        </a>
      </small>
    </div>
